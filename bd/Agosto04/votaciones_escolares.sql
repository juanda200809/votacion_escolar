...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-08-2026 a las 05:48:45
...
(8, 'diomedez', 'diaz', '1104', '6a54464148c25.jpg', 'parranda y ron todos los dias para gozar', 1, 4, 1);
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('administrador','estudiante','jurado') NOT NULL,
...
(9, 'admin', 'Administrador', 'Sistema', 'admin@colegio.com', NULL, '$2y$10$tLarSvyHg7rUImhJ0zA2e.RKjH1qzaJ4YbuUQJ44Vz4Jm/0ZOSTO6', 'administrador', '2026-07-08 21:23:04'),
(10, '1072661698', 'juan', 'Cantor', 'juandavidoterocantor20@gmail.com', '1104', '$2y$10$YEQOY/AWMmRDBD02I.FUSOo6OV9Gm0cQ.MSF7hvO/L0pYoUqNMif2', 'estudiante', '2026-07-09 04:40:23'),
...
(15, '1000000002', 'Jurado', 'Principal', '', '', '$2y$10$S59hhWOxk1TQ9Fjo4LAvZuI57v7r3.DyuVw1JueK8DsI0W4wdHeCy', '', '2026-08-13 03:00:16'),
(16, 'jurado', 'angela', 'Cantor', '', '', '$2y$10$MAz3GWOM3Ta3bAkbXRNiruqWzcG6ikm6HQH4iQCwrT8ufPeTM8Poa', 'jurado', '2026-08-21 23:34:26'),
(17, '1072364924', 'jhostyn', 'caraballo', '', '1104', '$2y$10$rByZxTO9DenMmjsZyPWEV.DD3MpuSDuWQwBvPDD4wqa7UiBMVkNPy', 'estudiante', '2026-08-22 04:04:05'),
(18, '1072453639', 'isabela', 'caicedo', '', '1104', '$2y$10$8f2R9KqWUVmOp9y0nMGuyebReW6gnrlUzyFc6.DTg5tyxrCir2Caq', 'estudiante', '2026-08-23 14:15:09'),
(19, '1072335426', 'lizeth', 'gutierres', '', '1104', '$2y$10$MGwS.NzaVQ7FGF4MgdMwEucgpTL4tMkz3VsmvtYqsh4f9f8asyTqy', 'estudiante', '2026-08-25 01:15:46');
...
(2, 17, 8, 4, '2026-08-22 04:28:53', 1),
(3, 12, 8, 4, '2026-08-22 04:29:20', 1),
(4, 11, 8, 4, '2026-08-22 04:29:41', 1),
(5, 18, 8, 4, '2026-08-23 15:07:47', 1),
(6, 19, 8, 4, '2026-08-25 01:57:14', 1);
...
ALTER TABLE `votos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `voto_unico_eleccion` (`id_usuario`,`id_eleccion`,`id_cargo`),
